...
|-------------|--------------|----------------|
| 🌐 **Sistema SPA + API REST** | CRUD completo de contatos com autenticação e front-end dinâmico. | [web-contact-api](#) |
| 🎓 **Sistema Educacional** | Gerenciamento de alunos, notas e ranking técnico. | [web-educacional](#) |
| ⚙️ **Automação de Granja com ESP32** | Controle térmico automatizado e integração com API PHP. | [iot-automation-granja](#) |
| 📱 **App Android - Controle IoT** | Aplicativo mobile para monitorar sensores e enviar comandos. | [android-iot-control](#) |
| 🧩 **Plataforma de Lógica de Programação** | Ferramenta educacional com exercícios práticos e correção automática. | [educational-logic-platform](#) |

---

## 🧭 Áreas de Interesse
- Desenvolvimento **Full Stack** (PHP, JS, APIs REST)
- **Mobile Apps** Android e Flutter
- **IoT e Automação** com ESP32/Arduino
- **Educação Tecnológica** e plataformas de ensino
...
<img height="180em"
src="https://github-readme-streak-stats.herokuapp.com/?user=edugouveia&theme=tokyonight"/>
